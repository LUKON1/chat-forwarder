  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setError(errorData.error || t("registration_failed"));
        return;
      }
      ...
      <div ref={formRef} className="w-full max-w-md">
        <Card size="lg" className="p-8 relative">
          ...
          <div className="text-center mb-8 mt-2">
            <h2 className="text-xl font-mono font-bold uppercase tracking-wide text-lime-cream-200">{t("register_title")}</h2>
          </div>
          ...
          {success && (
            <div className="bg-yale-blue-800 border-2 border-black text-lime-cream-50 text-xs font-mono p-3 mb-6 neo-shadow-sm">
